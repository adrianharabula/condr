    ...
    public function run()
    {
      ...
      for($i=0; $i<20; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'technics'),
            'views' => rand(0,2000),
            'category_id' => 1,
      ...
      for($i=0; $i<20; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'fashion'),
            'views' => rand(0,2000),
            'category_id' => 2,
            'company_id' => $companies[rand(0, count($companies) - 1)],
          ]);
      ...
      for($i=0; $i<20; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'abstract'),
            'views' => rand(0,2000),
            'category_id' => 5,
            'company_id' => $companies[rand(0, count($companies) - 1)],
          ]);
      ...
      for($i=0; $i<100; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'city'),
            'views' => rand(0,2000),
            'category_id' => 6,
            'company_id' => $companies[rand(0, count($companies) - 1)],
          ]);
      ...
      for($i=0; $i<20; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'animals'),
            'views' => rand(0,2000),
            'category_id' => 7,
            'company_id' => $companies[rand(0, count($companies) - 1)],
          ]);
      ...
      for($i=0; $i<20; $i++) {
        DB::table('products')->insert([
            ...
            'image_url' => $Faker->imageUrl($width=300, $height=300 , 'sports'),
            'views' => rand(0,2000),
            'category_id' => 8,
            'company_id' => $companies[rand(0, count($companies) - 1)],
          ]);
