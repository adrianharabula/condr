...
<section class="container-fluid" id="section1"><br><br>
    ...
    <div class="container">
      <div class="row">
          <div class="col-sm-4">
            <div class="row">
              <div class="col-sm-10 col-sm-offset-2 text-center"><h3>Complex</h3><p>Our application can offer great support when it comes to making decisions not only for the large database that stands beside it, but also for statistics and opinions taken from other users.</p>
          ...
          <div class="col-sm-4 text-center">
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1 text-center"><h3>Simple</h3><p>The use of this application is very easy and can be done by anybody with just a few clicks.</p>
          ...
          <div class="col-sm-4 text-center">
            <div class="row">
              <div class="col-sm-10 text-center"><h3>Adaptable</h3><p>The application is web responsive, which means that you can use it very easily from your tablet, phone, laptop or any other device that has a screen incorporated.</p>
